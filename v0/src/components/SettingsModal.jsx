...
import { X, Key, Eye, EyeOff, Trash2, AlertCircle, CheckCircle2 } from 'lucide-react';
...
export default function SettingsModal({ isOpen, onClose, apiKey, onSave, onClear, onClearData }) {
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-5 space-y-5 max-h-[90vh] overflow-y-auto">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400 mb-3">
            Necesaria para el análisis de patrones con IA. Se guarda solo en este dispositivo y nunca se envía a ningún servidor externo.
          </p>
        ...
        <div className="border-t border-gray-100 pt-4">
          ...
          {!confirmDelete ? (
            ...
            <div className="bg-rose-50 border border-rose-200 rounded-xl p-3 space-y-3">
              ...
              <div className="flex gap-2">
                <button
                  onClick={() => { onClearData(); setConfirmDelete(false); onClose(); }}
