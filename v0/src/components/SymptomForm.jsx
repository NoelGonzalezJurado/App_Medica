...
const EMPTY = { name: '', customName: '', intensity: 5, date: nowLocal(), bodyArea: '', notes: '' };
...
export default function SymptomForm({ onSubmit }) {
  ...
  function handleSubmit(e) {
    ...
    onSubmit({ name: displayName.trim(), intensity: form.intensity, date: form.date, bodyArea: form.bodyArea, notes: form.notes });
