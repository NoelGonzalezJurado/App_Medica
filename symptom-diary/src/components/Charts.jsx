...
export const PALETTE = ['#0d9488', '#0ea5e9', '#8b5cf6', '#f59e0b', '#f43f5e', '#10b981', '#6366f1', '#ec4899'];

export function intColor(v) {
  if (v <= 3) return '#10b981';
  if (v <= 6) return '#f59e0b';
  return '#f43f5e';
}

export function buildTimeline(symptoms) {
  const map = {};
  [...symptoms]
...
export function buildFrequency(symptoms) {
  const freq = {};
...
export function buildAvgIntensity(symptoms) {
  const map = {};
  symptoms.forEach(s => {
